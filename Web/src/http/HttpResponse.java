...
public class HttpResponse {
    ...
    public OutputStream clienteOutput;
    ...
    private void writeHeader(PrintWriter writer) throws IOException {
        for (Entry<String, String> entry : headerFields.entrySet()) {
            System.out.println("DEBUG: Header: " + entry.getKey() + ": " + entry.getValue());
        ...
        if (!cookies.isEmpty()) {
            ...
            System.out.print("DEBUG: Header: " + setcookie);
            writer.print(setcookie);
